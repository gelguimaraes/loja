 ...
 */
add_action('admin_bar_menu', 'eightstore_lite_bar_menu', 1000);
function eightstore_lite_bar_menu() {
	global $wp_admin_bar;
	if(!is_super_admin() || !is_admin_bar_showing()) return;

	$wp_admin_bar->add_menu(array(
		'parent' => 'site-name',
		'title' => '<span class="es-admin-bar">About EightStore Lite</span>',
		'href' => admin_url('themes.php?page=eightstore-lite-about'),
		'id' => 'es-about-menu'
	));
}
		...
		<div class="wrap eightstore-lite-wrap">
			...
			<div class="bottom-block">
				<ul class="eightstore-lite-tab-wrapper wp-clearfix">
					...
					<li><a href="<?php echo esc_url( admin_url( 'themes.php?page=eightstore-lite-about&tab=more_wp' ) ); ?>"
						class="eightstore-lite-tab <?php echo $active_tab == 'more_wp' ? 'eightstore-lite-tab-active' : ''; ?> "><?php echo esc_html__( 'More WordPress Stuff', 'eightstore-lite' ); ?>
