	...
	public static function activate_checks() {
		$channel_statics = array (
 		        ...
 		        "Czech Republic" => array (
  		        ...
  		        "Denmark" => array (
					...
					"utm_source" => "Smartly.io",
                        		"type" => "Advertising" ),
           			"Spartoo" => array (
                        		"channel_hash" => md5("Spartoo.dk"),
                        		"name" => "Spartoo.dk",
					"fields" => "customfeed",
					"taxonomy" => "none",
					"utm_source" => "Spartoo.dk",
                        		"type" => "Marketplace" ),
            			"Pricerunner" => array (
  		        ...
  		        "Finland" => array (
   				...
   				"Hintaseuranta" => array (
					...
					"utm_source" => "Hintaseuranta.fi",
                        		"type" => "Comparison shopping engine" ),
            			"Spartoo" => array (
                        		"channel_hash" => md5("Spartoo.fi"),
                        		"name" => "Spartoo.fi",
					"fields" => "customfeed",
					"taxonomy" => "none",
					"utm_source" => "Spartoo.fi",
                        		"type" => "Marketplace" ),
        			),
  		        "France" => array (
                		"Connexity" => array (
					...
					"utm_source" => "Fnac.fr",
                        		"type" => "Marketplace" ),
  	             		"Spartoo" => array (
                        		"channel_hash" => md5("Spartoo.fr"),
                        		"name" => "Spartoo.fr",
					"fields" => "customfeed",
					"taxonomy" => "none",
					"utm_source" => "Spartoo.fr",
                        		"type" => "Marketplace" ),
   	             		"Spartoo" => array (
                        		"channel_hash" => md5("Spartoo.fr"),
                        		"name" => "Spartoo.fr",
			...
			"Georgia" => array (),
  		        "Germany" => array (
					...
					"utm_source" => "Crowdfox.com",
                        		"type" => "Marketplace" ),
 	   			"Spartoo" => array (
                        		"channel_hash" => md5("Spartoo.de"),
                        		"name" => "Spartoo.de",
					"fields" => "customfeed",
					"taxonomy" => "none",
					"utm_source" => "Spartoo.de",
                        		"type" => "Marketplace" ),
 	   			"Real.de" => array (
			...
			"Nepal" => array (),
        		"Netherlands" => array (
					...
					"utm_source" => "Fruugo.nl",
                        		"type" => "Marketplace" ),
           			"Spartoo.nl" => array (
                        		"channel_hash" => md5("Spartoo.nl"),
                        		"name" => "Spartoo.nl",
					"fields" => "customfeed",
					"taxonomy" => "none",
					"utm_source" => "Spartoo.nl",
                        		"type" => "Marketplace" ),
      				"Ooshopping.nl" => array (
			...
			"Philippines" => array (),
  		        ...
  		        "Portugal" => array (
                		"Spartoo" => array (
                        		"channel_hash" => md5("Spartoo.pt"),
                        		"name" => "Spartoo.pt",
					"fields" => "customfeed",
					"taxonomy" => "none",
					"utm_source" => "Spartoo.pt",
                        		"type" => "Marketplace" ),
  	              		"ShopMania" => array (
			...
			"Sweden" => array (
					...
					"utm_source" => "Adform",
                        		"type" => "Advertising" ),
                		"Spartoo" => array (
                        		"channel_hash" => md5("Spartoo.se"),
                        		"name" => "Spartoo.se",
					"fields" => "customfeed",
					"taxonomy" => "none",
					"utm_source" => "Spartoo.se",
                        		"type" => "Marketplace" ),
                		"Kelkoo" => array (
			...
			"United Arab Emirates" => array (),
  		        "United Kingdom" => array (
					...
					"utm_source" => "TheNextAd.com",
                        		"type" => "Advertising" ),
    				"Spartoo" => array (
                        		"channel_hash" => md5("Spartoo.co.uk"),
                        		"name" => "Spartoo.co.uk",
					"fields" => "customfeed",
					"taxonomy" => "none",
